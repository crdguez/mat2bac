...
\title{\Huge \textbf{Preparación EVAU}  \\ \emph{}  \\\bigskip  \huge Matemáticas II - 2º Bachillerato 
%\footnote{\url{}}
\\ \bigskip 
{
\foreach \k in {4}
...
\textbf{ATRIBUCIONES:} Nuestro más sentido \textbf{agradecimiento} a Julio García Galavis, que es el autor de la resolución de los ejercicios\footnote{\url{http://matematicasentumundo.es/PAU/PAU.htm}}.
...
\includepdf[pages=-, scale=0.9]{preparacion_analisis.pdf}



\chapter{Probabilidad y Estadística}

A continuación aparecen los ejercicios de la EVAU del bloque de probabilidad de los últimos años con las soluciones. Se recomienda trabajarlos para preparar la EVAU. En caso de necesitar consultar el desarrollo de la solución paso a paso se deberá consultar el documento específico de la prueba y año que aparece en la siguiente web\footnote{\url{http://matematicasentumundo.es/PAU/PAU.htm}}:\\
...
\includepdf[pages=-, scale=0.9]{preparacion_prob.pdf}

\chapter{Álgebra}

A continuación aparecen los ejercicios de la EVAU del bloque de álgebra de los últimos años con las soluciones. Se recomienda trabajarlos para preparar la EVAU. En caso de necesitar consultar el desarrollo de la solución paso a paso se deberá consultar el documento específico de la prueba y año que aparece en la siguiente web\footnote{\url{http://matematicasentumundo.es/PAU/PAU.htm}}:\\
...
\includepdf[pages=-, scale=0.9]{preparacion_alg.pdf}


\chapter{Geometría}

A continuación aparecen los ejercicios de la EVAU del bloque de geometría de los últimos años con las soluciones. Se recomienda trabajarlos para preparar la EVAU. En caso de necesitar consultar el desarrollo de la solución paso a paso se deberá consultar el documento específico de la prueba y año que aparece en la siguiente web\footnote{\url{http://matematicasentumundo.es/PAU/PAU.htm}}:\\
...
\includepdf[pages=-, scale=0.9]{preparacion_geom.pdf}
